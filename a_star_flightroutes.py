    ...
    def a_star_with_exclusions(start_id, end_id, excluded_paths):
        try:
            ...
            while pq:
                ...
                # subsequent loop: sorted by current_weight in ascesnding order
                ...
                for neighbor in graph.adjacency_list[current_vertex]:
                    ...
                    # check if new distance neighbour is shorter than previously known one or replace float(inf)
